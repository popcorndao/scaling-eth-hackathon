...
export function _hexToString(hex) {
	let str = '';
...
export async function getOptimismRevertReason( tx, provider ) {
	try {
...
export async function assertRevertOptimism({ tx, reason, provider }) {
	let receipt;
	let revertReason;
	try {
